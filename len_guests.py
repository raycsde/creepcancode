#ray2026mar7 length of my guests
my_guests = []
...
print(f'There are {len(my_guests)} guests coming to my dinner.')#注意：任何时候前后符号一起写，不然会忘记！！！

guest_notime = my_guests.pop(0)
print(f"It's a pity that {guest_notime} can't come to my dinner!")
print(f'There are {len(my_guests)} guests coming to my dinner.')
...
del my_guests[0]
print(my_guests)
print(f'There are {len(my_guests)} guest coming to my dinner.')
